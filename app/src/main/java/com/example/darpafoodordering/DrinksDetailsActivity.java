...
public class DrinksDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(quantity1 == 0){
                    Toast.makeText(DrinksDetailsActivity.this, "Invalid Quantity!", Toast.LENGTH_SHORT).show();
                }else{
                    AddToCart();
                }
            }
                        ...
                        if(task.isSuccessful()){
                            cartListRef.child("adminView").child(currentUser.getUid()).child("orders").child(saveTimeStamp)
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                Toast.makeText(DrinksDetailsActivity.this, "Added to Cart!", Toast.LENGTH_SHORT).show();
                                                Intent intent = new Intent(DrinksDetailsActivity.this, MenuActivity.class);
    ...
    public void retrieveMenuDetails(){
        ...
        DatabaseReference menu = FirebaseDatabase.getInstance().getReference().child("Menu").child("Drinks");
    ...
    public void ClickHome(View view){
        redirectActivity(DrinksDetailsActivity.this, UserHomepage.class);
    }
    //calls function redirectActivity for intent
    public void ClickMenu(View view){
        redirectActivity(DrinksDetailsActivity.this, MenuActivity.class);
    }
    //calls function redirectActivity for intent
    public void ClickNotifications(View view){
        redirectActivity(DrinksDetailsActivity.this, NotificationsActivity.class);
    }
    public void ClickMyAccount(View view){
        redirectActivity(DrinksDetailsActivity.this, AccountActivity.class);
    }
    public void ClickCart(View view){
        redirectActivity(DrinksDetailsActivity.this, CartActivity.class);
    }
    public void ClickOrders(View view){redirectActivity(DrinksDetailsActivity.this, OrdersActivity.class);}
