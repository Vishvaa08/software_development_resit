...
public class ViewUserWesternAdapter extends FirebaseRecyclerAdapter<ViewUserMenuHelperClass,ViewUserWesternAdapter.viewHolder>{

    public ViewUserWesternAdapter(@NonNull FirebaseRecyclerOptions<ViewUserMenuHelperClass> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull viewHolder holder, int position, @NonNull ViewUserMenuHelperClass model) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(holder.itemView.getContext(), WesternDetailsActivity.class);
