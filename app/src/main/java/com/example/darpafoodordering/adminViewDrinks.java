...
public class adminViewDrinks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(adminViewDrinks.this, editDrinks.class);
                intent.putExtra("val", searchValue);
                startActivity(intent);
            }
        });
        recyclerView = findViewById(R.id.view_drinks_recyclerview);
        recyclerView.setLayoutManager(new LinearLayoutManager(adminViewDrinks.this));
        ...
        FirebaseRecyclerOptions<viewMenuHelperClass> options =
                new FirebaseRecyclerOptions.Builder<viewMenuHelperClass>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Menu").child("Drinks").orderByChild("foodtype").startAt(drinks).endAt(drinks), viewMenuHelperClass.class)
                        .build();
    ...
    public void adminHome(View view){
        redirectActivity(adminViewDrinks.this, admin_home.class);
    }
    //calls function redirectActivity for intent
    public void selectUsers(View view){
        redirectActivity(adminViewDrinks.this, selectUser.class);
    }
    //recreates page
    public void manageMenu(View view){
        redirectActivity(adminViewDrinks.this, manageMenu.class);
    }
    public void userHome(View view){redirectActivity(adminViewDrinks.this, UserHomepage.class);}
