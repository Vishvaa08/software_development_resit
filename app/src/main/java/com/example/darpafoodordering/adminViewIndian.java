...
public class adminViewIndian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_indian);
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(adminViewIndian.this, editIndian.class);
                intent.putExtra("val", searchValue);
                startActivity(intent);
            }
        });
        recyclerView = findViewById(R.id.view_indian_recyclerview);
        recyclerView.setLayoutManager(new LinearLayoutManager(adminViewIndian.this));
        ...
        FirebaseRecyclerOptions<viewMenuHelperClass> options =
                new FirebaseRecyclerOptions.Builder<viewMenuHelperClass>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Menu").child("Indian").orderByChild("foodtype").startAt(indian).endAt(indian), viewMenuHelperClass.class)
                        .build();
    ...
    public void adminHome(View view){
        redirectActivity(adminViewIndian.this, admin_home.class);
    }
    //calls function redirectActivity for intent
    public void selectUsers(View view){
        redirectActivity(adminViewIndian.this, selectUser.class);
    }
    //recreates page
    public void manageMenu(View view){
        redirectActivity(adminViewIndian.this, manageMenu.class);
    }
    public void userHome(View view){redirectActivity(adminViewIndian.this, UserHomepage.class);}
