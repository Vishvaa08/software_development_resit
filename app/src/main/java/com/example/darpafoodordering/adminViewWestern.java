...
public class adminViewWestern extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_western);
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(adminViewWestern.this, editWestern.class);
                intent.putExtra("val", searchValue);
                startActivity(intent);
            }
        });
        recyclerView = findViewById(R.id.view_western_recyclerview);
        recyclerView.setLayoutManager(new LinearLayoutManager(adminViewWestern.this));
        ...
        FirebaseRecyclerOptions<viewMenuHelperClass> options =
                new FirebaseRecyclerOptions.Builder<viewMenuHelperClass>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Menu").child("Western").orderByChild("foodtype").startAt(western).endAt(western), viewMenuHelperClass.class)
                        .build();
    ...
    public void adminHome(View view){
        redirectActivity(adminViewWestern.this, admin_home.class);
    }
    //calls function redirectActivity for intent
    public void selectUsers(View view){
        redirectActivity(adminViewWestern.this, selectUser.class);
    }
    //recreates page
    public void manageMenu(View view){
        redirectActivity(adminViewWestern.this, manageMenu.class);
    }
    public void userHome(View view){redirectActivity(adminViewWestern.this, UserHomepage.class);}
