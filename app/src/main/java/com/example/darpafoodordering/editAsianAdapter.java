...
public class editAsianAdapter  extends FirebaseRecyclerAdapter<viewMenuHelperClass,editAsianAdapter.viewHolder> {

    public editAsianAdapter(@NonNull FirebaseRecyclerOptions<viewMenuHelperClass> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull editAsianAdapter.viewHolder holder, final int position, @NonNull viewMenuHelperClass model) {
            ...
            public void onClick(View view) {
                ...
                btnConfirmEdit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Menu").child("Asian")
    ...
    @NonNull
    @Override
    public editAsianAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.edit_menu_layout, parent, false);
        return new editAsianAdapter.viewHolder(view);
    }
