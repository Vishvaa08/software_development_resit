...
public class editDrinks extends AppCompatActivity {

    DrawerLayout drawerLayout;
    RecyclerView recyclerView;
    editDrinksAdapter mainAdapter;
    ImageView btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(editDrinks.this, manageMenu.class);
                startActivity(intent);
            }
        });

        recyclerView = findViewById(R.id.edit_drinks_recyclerview);
        recyclerView.setLayoutManager(new LinearLayoutManager(editDrinks.this));
        ...
        FirebaseRecyclerOptions<viewMenuHelperClass> options =
                new FirebaseRecyclerOptions.Builder<viewMenuHelperClass>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Menu").child("Drinks").orderByChild("name").startAt(val).endAt(val), viewMenuHelperClass.class)
                        .build();

        mainAdapter = new editDrinksAdapter(options);
    ...
    public void adminHome(View view){
        redirectActivity(editDrinks.this, admin_home.class);
    }
    //calls function redirectActivity for intent
    public void selectUsers(View view){
        redirectActivity(editDrinks.this, selectUser.class);
    }
    //calls function redirectActivity for intent
    public void manageMenu(View view){
        redirectActivity(editDrinks.this, manageMenu.class);
    }
    public void userHome(View view){redirectActivity(editDrinks.this, UserHomepage.class);}
