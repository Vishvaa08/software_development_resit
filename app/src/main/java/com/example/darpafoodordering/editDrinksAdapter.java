...
public class editDrinksAdapter  extends FirebaseRecyclerAdapter<viewMenuHelperClass,editDrinksAdapter.viewHolder> {

    public editDrinksAdapter(@NonNull FirebaseRecyclerOptions<viewMenuHelperClass> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull editDrinksAdapter.viewHolder holder, final int position, @NonNull viewMenuHelperClass model) {
            ...
            public void onClick(View view) {
                ...
                btnConfirmEdit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Menu").child("Drinks")
    ...
    @NonNull
    @Override
    public editDrinksAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.edit_menu_layout, parent, false);
        return new editDrinksAdapter.viewHolder(view);
    }
