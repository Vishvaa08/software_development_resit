...
public class editStaff extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.edit_staff_recyclerview);
        recyclerView.setLayoutManager(new LinearLayoutManager(editStaff.this));
        ...
        FirebaseRecyclerOptions<viewStaffHelperClass> options =
                new FirebaseRecyclerOptions.Builder<viewStaffHelperClass>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("users").orderByChild("name").startAt(val).endAt(val), viewStaffHelperClass.class)
                        .build();

        mainAdapter = new editStaffAdapter(options);
    ...
    public void adminHome(View view){
        redirectActivity(editStaff.this, admin_home.class);
    }
    //calls function redirectActivity for intent
    public void selectUsers(View view){
        redirectActivity(editStaff.this, selectUser.class);
    }
    //calls function redirectActivity for intent
    public void manageMenu(View view){
        redirectActivity(editStaff.this, manageMenu.class);
    }
    public void userHome(View view){redirectActivity(editStaff.this, UserHomepage.class);}
