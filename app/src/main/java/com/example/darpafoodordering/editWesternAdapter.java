...
public class editWesternAdapter  extends FirebaseRecyclerAdapter<viewMenuHelperClass,editWesternAdapter.viewHolder> {

    public editWesternAdapter(@NonNull FirebaseRecyclerOptions<viewMenuHelperClass> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull editWesternAdapter.viewHolder holder, final int position, @NonNull viewMenuHelperClass model) {
            ...
            public void onClick(View view) {
                ...
                btnConfirmEdit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Menu").child("Western")
    ...
    @NonNull
    @Override
    public editWesternAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.edit_menu_layout, parent, false);
        return new editWesternAdapter.viewHolder(view);
    }
