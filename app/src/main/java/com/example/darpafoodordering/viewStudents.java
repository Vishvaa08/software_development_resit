...
public class viewStudents extends AppCompatActivity {
    ...
    viewStudentsAdapter mainAdapter;
    EditText searchbar;
    ImageView btnSearch;
    String searchValue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(viewStudents.this, editStudents.class);
                intent.putExtra("val", searchValue);
                startActivity(intent);
            }
        });
        recyclerView = findViewById(R.id.view_students_recyclerview);
        ...
        FirebaseRecyclerOptions<viewStudentsHelperClass> options =
                new FirebaseRecyclerOptions.Builder<viewStudentsHelperClass>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("users").orderByChild("role").startAt(Student).endAt(Student), viewStudentsHelperClass.class)
                        .build();

        mainAdapter = new viewStudentsAdapter(options);
    ...
    public void adminHome(View view){
        redirectActivity(viewStudents.this, admin_home.class);
    }
    //calls function redirectActivity for intent
    public void selectUsers(View view){
        redirectActivity(viewStudents.this, selectUser.class);
    }
    //recreates page
    public void manageMenu(View view){
        redirectActivity(viewStudents.this, manageMenu.class);
    }
    public void userHome(View view){redirectActivity(viewStudents.this, UserHomepage.class);}
